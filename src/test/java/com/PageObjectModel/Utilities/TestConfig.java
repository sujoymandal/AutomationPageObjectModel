...
public class TestConfig{
	...
	public static String from = "sujoymandal33@gmail.com";
	public static String password = "Sujoy@rs18";
	public static String[] to ={"sujoymandal33@gmail.com","sujoyautomationqa@gmail.com"};
